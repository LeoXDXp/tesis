...
Luego, a partir de la matriz $n$ se obtiene su primer vector propio $e_1$ que representa la orientaci\'on principal de los filamentos en el \'area de inter\'es, mientras que la diferencia de los eigenvalores $n_1$ y $n_2$ ($n_1 > n_2$), denominada $q = n_1 - n_2$, define la anisotrop\'ia.
...
\begin{figure}[t]
    ...
    \caption{A partir de la segmentaci\'on obtenida con la libreria MCALab (figura a), se aplican los filtros Gaussiano, Laplaciano y Gaussiano direccional para obtener una intensificaci\'on de los filamentos (figura b). Fuente: \cite{alioscha2016robust}}
...
Investigaciones similares posibles de agregar a esta categor\'ia, dado su uso enfocado primariamente en herramientas de visi\'on por computador son \cite{doi:10.1021/ma502264c}\cite{lichtenstein2003quantitative}\cite{asgharzadeh2018computational}. 
