...
\begin{figure}[h]
        \centering
        \includegraphics[]{imagenes/MT-LFT.jpeg}
        \label{fig:MTLFT}
...
\begin{figure}[h]
        \centering
        \includegraphics[]{imagenes/MT-OFT.jpeg}
        \label{fig:MTOFT}
...
\begin{figure}[h]
        \centering
        \includegraphics[]{imagenes/fibritool.jpg}
        \label{fig:fibritool}
...
\begin{figure}[h]
        \centering
        \includegraphics[]{imagenes/QuantitativeIFS.png}
        \label{fig:IFS}
