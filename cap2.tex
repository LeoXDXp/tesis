...
La extraci\'on o generaci\'on de un grafo que representa una red de filamentos a partir de una imagen es el paso que define la cantidad de informaci\'on disponible para llevar a cabo la individualizaci\'on de filamentos. La importancia de este procedimiento radica en que a partir de la imagen es posible obtener una cantidad de caracter\'isticas de distinta \'indole, lo que permite desagregar el grafo $G$ en subgrafos, siendo la primera forma de disminuir el espacio de b\'usqueda. Con las herramientas actuales disponibles en la literatura es posible realizar una extracci\'on de un red de filamentos con algunas propiedades, siendo la conexi\'on con el an\'alisis de la red obtenida mediante un grafo un procedimiento no automatizado. Esto significa que al ser un paso manual, el experto realiz\'andolo puede simplemente realizar la individualizaci\'on de manera manual.
...
Con el fin de aportar en automatizar la extracci\'on de informaci\'on de una imagen para la generaci\'on de un grafo que representa una red de filamentos, se cre\'o una herramienta que ...
