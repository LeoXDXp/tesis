...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        ...
        \label{fig:SpinningMarchantiaResults-a}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        ...
        \label{fig:SpinningMarchantiaResults-b}
    \end{subfigure}
    ~ 
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        ...
        \label{SpinningMarchantiaResults-c}
    \end{subfigure}
    \vskip\baselineskip
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        ...
        \label{fig:SpinningMarchantiaResults-d}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        ...
        \label{fig:SpinningMarchantiaResults-e}
    \end{subfigure}
    ~ 
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        ...
        \label{fig:SpinningMarchantiaResults-f}
    \end{subfigure}
    
    \caption{Individualizaci\'on  de filamentos de la figura \ref{fig:SpinningMarchantia} realizadas con DeFiNe y Phil. Segmentos marcados en negro con y sin discontinuidad representan aristas no asignadas correctamente al filamento correspondiente en el {\it ground truth.}.}
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Filamentos correctamente individualizados por DeFiNe con 30\textdegree identificados con colores}
        \label{fig:field3t0filtered1Results-d}
    \end{subfigure}
    \vskip\baselineskip
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Filamentos correctamente individualizados por DeFiNe con 60\textdegree identificados con colores}
        \label{fig:field3t0filtered1Results-e}
    \end{subfigure}
...
\begin{table}[h]
    ...
    \hline
        ...
        Define 60° & 100 & 1 & 16 & 5 & 31.25 & 41.6667 & 16.2042 \\ 
        Phil & 100 & 15 & 7.8 & 52.0952 & 65 & 0.9693 \\
        \hline
    \end{tabular}
...
La individualizaci\'on de filamentos para la figura \ref{fig:field3t0filtered2} resulta en un empate entre Phil y la configuraci\'on de DeFiNe con 60\textdegree, encontrando 4 de 5 filamentos cada uno, mientras que DeFiNe con 30\textdegree como umbral encuentra s\'olo 3 de 5 filamentos. El filamento faltante en DeFiNe-60\textdegree es el que esta compuesto s\'olo por la arista 4 (figura \ref{fig:field3t0filtered2Results-d}), mientras que en DeFiNe-30\textdegree se lleva a cabo una asignaci\'on de las aristas 0-3 a un filamento, y de la arista 1 a otro, siendo la combinaci\'on correcta seleccionar la arista 0 por si sola y las aristas 3-1 en conjunto (figura \ref{fig:field3t0filtered2Results-e}). Similar a lo que realiza Phil, tambi\'en asignado las aristas 3-0 a un filamento, pero a su vez asignando correctamente las aristas 3-1 (figura \ref{fig:field3t0filtered2Results-f}).  


En el caso de Phil, la elecci\'on de las aristas 0-3 para formar un filamento se condice con el comportamiento del algoritmo en buscar caminos de mayor longitud que cumplan con el criterio de rectitud. Por otra parte, este caso en un microt\'ubulo puede corresponder a la fusi\'on de 2 microt\'ubulos en uno, denominado {\sc Zippering}, o al nacimiento de un microt\'ubulo a partir de uno existente, llamado {\sc Nucleaci\'on}. Ambas situaciones requieren de informaci\'on adicional, como el grosor de los segmentos de filamentos, as\'i como que el \'angulo entre los segmentos de filamentos que se separan del segmento com\'un este en un rango que var\'ia seg\'un el tipo de c\'elula, para aclarar cual es el caso observado. 
...
\begin{figure*}[h!]
    ...
    \caption{Individualizaci\'on  de filamentos de la figura \ref{fig:field3t0filtered2} realizadas con DeFiNe y Phil. Segmentos marcados en negro con y sin discontinuidad representan aristas no asignadas correctamente al filamento correspondiente en el {\it ground truth.}.}
