...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Individualizaci\'on de filamentos obtenida mediante DeFiNe con un \'angulo de 30\textdegree .}
        \label{fig:}
    \end{subfigure}%
    \hspace{0.2cm}
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \caption{4 filamentos correctamente individualizados a partir de los resultados de (a), identificados con colores.}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \caption{Individualizaci\'on de filamentos obtenida mediante DeFiNe con un \'angulo de 60\textdegree .}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \caption{3 filamentos correctamente individualizados a partir de los resultados de (c), identificados con colores.}
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Individualizaci\'on de filamentos obtenida mediante DeFiNe con un \'angulo 30\textdegree para la generaci\'on de caminos.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{3 filamentos correctamente individualizados en base al resultado en (a), identificados con colores.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[scale=0.08]{resultImages/defineFig1b-DeFiNeExactMatch-60.png}
        \caption{4 filamentos correctamente individualizados en base al resultado en (a), identificados con colores.}
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[height=1.5in]{resultImages/50-ROIs-Spinning-Marchantia-phil-s0-v05-nobg-antLabeled.png}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[height=1.5in]{resultImages/50-ROIs-Spinning-Marchantia-phil-s0-v05-exactMatch-antLabeled-thick.png}
