...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/AVG_SPINNING DISK MARCHANTIA.png}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/MAX_SPINNING DISK MARCHANTIA_gtruth.png}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/50_ROIs_Spinning_Marchantia_solved_rot_unlabeled.png}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/50_ROIs_Spinning_Marchantia_graph_og.png}
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/field3_t0_2cellBcrop_filtered_1.png}
        \caption{}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/field3_t0_2cellBcrop_filtered_1_rois.png}
        \caption{Filamentos manualmente individualizados por un experto}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/}
        \caption{Codificaci\'on por color de la individualizaci\'on manual}
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/field3_t0_2cellBcrop_filtered_2.png}
        \caption{}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=1.5in]{benchImages/field3_t0_2cellBcrop_filtered_2_rois.png}
        \caption{Filamentos manualmente individualizados por un experto}
