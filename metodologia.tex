...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        & & & &\\
         \hline
        Neurona & 45\textdegree & 2 & Si & No\\
        MT Planta & 30\textdegree & 1.5 & Si & Si\\
        MT Animal & 60\textdegree & 2.5 & Si & Si\\
        Sint\'etico & 45\textdegree & 1.5 & Si & No \\
        \hline
    \end{tabular}
    \caption[Configuraci\'on de par\'ametros predefinidos por tipo de c\'elula.]{Configuraci\'on de par\'ametros predefinidos por tipo de c\'elula. MT es la abreviaci\'on de microt\'ubulo. Todos los par\'ametros indicados son ajustables por el usuario.}
...
\begin{figure*}[h!]
    ...
    \end{subfigure}
    \caption[Muestra N3 con su individualizaci\'on manual de una neurona de rat\'on.]{Individualizaci\'on manual de una neurona. a) Imagen de \cite{ampuero2019chronic} obtenida al realizar la proyecci\'on del eje Z bajo el criterio de valor m\'aximo de p\'ixeles. b) Representaci\'on mediante colores de los filamentos de la neurona, representando el ax\'on y las dendritas. d) Grafo de X aristas extra\'ido a partir de la individualizaci\'on manual.}
