...
Es un plugin de facil instalaci\'on para ImageJ

Como resultado FibrilTool entrega una l\'inea cuyo \'angulo representa la orientaci\'on promedio de los filamentos en la regi\'on de inter\'es, mientras que el largo es un indicador proporcional a la anistrop\'ia de los filamentos. El valor del largo y del \'angulo se pueden obtener con las herramientas existentes en ImageJ.
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{evalImages/cable1-soax.png}
    \caption[Imagen de ejemplo procesada con SOAX]{Imagen sint\'etica de ejemplo procesada con SOAX, identificando en color verde las intersecciones.}
