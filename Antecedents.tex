...
Debido a la complejidad al obtener informaci\'on cuantitativa de filamentos a partir de imagenes de microsco\'ia, las soluciones revisadas pueden ofrecer soluciones que requieren una alta interacci\'on humana o que permiten un cierto grado de automatizaci\'on con el costo asociado de tener muchos par\'ametros
...
Como resultado FibrilTool entrega una l\'inea cuyo \'angulo representa la orientaci\'on promedio de los filamentos en la regi\'on de inter\'es, mientras que el largo es un indicador proporcional a la anistrop\'ia de los filamentos. Lo anterior se refleja en la Figura \ref{fig:FibrilToolexample}. El valor del largo y del \'angulo se pueden obtener con las herramientas existentes en ImageJ.

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{evalImages/fibriltool-c1-mt-GFP-hipocotilo-zoom.png}
    \caption[Ejemplo de FibrilTool en microt\'ubulos]{Uso de FibrilTool en una imagen de microt\'ubulos de la planta {\it Arabidopsis Marchantia}. La secci\'on de inter\'es corresponde al \'area dentro de la regi\'on delimitada en amarillo. La l\'inea roja representa el resultado al ejecutar FibrilTool. Fuente: Elaboraci\'on Propia.}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{evalImages/MAX-cable1-std-4.jpg}
    \caption[Imagen de ejemplo de SOAX]{Imagen sint\'etica de ejemplo de SOAX, que representa una red de filamentos de actina. Fuente: \citet{xu2015soax}.}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{evalImages/cable1-soax.png}
    \caption[Imagen de ejemplo procesada con SOAX]{Imagen sint\'etica de ejemplo procesada con SOAX, identificando en color verde las intersecciones. Fuente: Elaboraci\'on Propia.}
...
%que permiten seguir filamentos en distintos tiempos, as\'i como llevar a cabo la agrupaci\'on de curvas par\'ametricas 
