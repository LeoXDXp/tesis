...
Como resultado, se obtiene un algoritmo flexible que individualiza filamentos de forma autom\'atica, que a su vez permite la incorporaci\'on de nuevas caracter\'isticas y/o restricciones. El algoritmo propuesto se evalua en casos sint\'eticos, as\'i como en microt\'ublos de planta y neuronas de rat\'on, logrando proponer un n\'umero de filamentos similar al que propone un experto de forma manual, en un tiempo inferior al minuto.
